...
const OPEN_WEATHER_API_KEY = "b58135dbf0a70cbc62cb44cc71d69da0";
...
class WeatherService {
  ...
  getDailyWeatherByPosition({ latitude, longitude }) {
    ...
    const url = `${OPEN_WEATHER_BASE_URL}/forecast?appid=${OPEN_WEATHER_API_KEY}&lat=${latitude}&lon=${longitude}&units=metric&cnt=7`;
    console.log(url);
